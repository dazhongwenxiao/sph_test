        ...
        <div class="details clearfix">
          ...
          <div class="sui-navbar">
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li @click="changeOrder('1')" :class="{active: isComprehensive}">
                  <a href="#">综合 <span class="iconfont" :class="{'icon-sort-desc': isDesc, 'icon-sort-asc': isAsc}" v-show="isComprehensive"></span></a>
                </li>
                <li @click="changeOrder('2')" :class="{active: isPrice}">
                  <a href="#">价格 <span class="iconfont" :class="{'icon-sort-desc': isDesc, 'icon-sort-asc': isAsc}" v-show="isPrice"></span></a>
                </li>
                <!-- <li>
                  <a href="#">销量</a>
                </li>
  ...
  export default {
    ...
    watch: {
      ...
      $route(newValue,oldValue){
        ...
        // 再次发起ajax请求
        this.getData()
        // 每一次请求完毕，应该把相应的1、2、3级分类的id置空的，让它接受下一次的相应1、2、3
        this.searchParams.category1Id = undefined
        this.searchParams.category2Id = undefined
        this.searchParams.category3Id = undefined
